var JanusVideoRoom = (function () {
  ...
  JanusVideoRoom.prototype.join = function (janusroomid, url, name) {
    ...
    fetch(this.janusUrl, { method: "POST", body: JSON.stringify(createReq) })
      ...
      .then((response) =>
        this.onCreateSession(response, janusroomid, url, name)
      )
  ...
  JanusVideoRoom.prototype.leave = function (janusroomid, url, name) {
    ...
    if (connection) {
      ...
      fetch(this.janusUrl + "/" + sessionId + "/" + pluginid, {
        method: "POST",
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onCreateSession = function (
    dataJson,
    janusroomid,
    url,
    name
    ...
    fetch(this.janusUrl + "/" + sessionId, {
      ...
      .then((response) => response.json())
      .then((response) =>
        this.onPluginsAttached(response, janusroomid, url, name, sessionId)
      )
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onPluginsAttached = function (
    dataJson,
    janusroomid,
    url,
    name,
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onJoinRoom = function (
    dataJson,
    janusroomid,
    url,
    name,
  ...
  // Janus callback for Video Room Joined
  // ------------------------------------------
  JanusVideoRoom.prototype.onJoinRoomResult = function (
    dataJson,
    janusroomid,
    url,
    name,
    ...
    if (dataJson.plugindata.data.videoroom === "joined") {
      // register connection
      this.connection[janusroomid + "_" + url + "_" + name] = {
        sessionId: sessionId,
        pluginId: pluginid,
      };
      ...
      if (name) {
        ...
        fetch(createOfferUrl)
          ...
          .then((response) => response.json())
          .then((response) =>
            this.onCreateOffer(response, name, sessionId, pluginid, peerid)
          )
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onCreateOffer = function (
    dataJson,
    name,
    sessionId,
    pluginid,
    ...
    fetch(this.janusUrl + "/" + sessionId + "/" + pluginid, {
      ...
      .then((response) => response.json())
      .then((response) =>
        this.onPublishStream(response, name, sessionId, pluginid, peerid)
      )
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onPublishStream = function (
    dataJson,
    name,
    sessionId,
    pluginid,
    ...
    fetch(
      ...
      .then((response) => response.json())
      .then((response) =>
        this.onPublishStreamResult(response, name, sessionId, pluginid, peerid)
      )
  ...
  // Janus callback for WebRTC stream is published
  // ------------------------------------------
  JanusVideoRoom.prototype.onPublishStreamResult = function (
    dataJson,
    name,
    sessionId,
    pluginid,
    ...
    if (dataJson.jsep) {
      fetch(this.srvurl + "/api/setAnswer?peerid=" + peerid, {
        method: "POST",
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onSetAnswer = function (
    dataJson,
    name,
    sessionId,
    pluginid,
    ...
    fetch(this.srvurl + "/api/getIceCandidate?peerid=" + peerid)
      ...
      .then((response) => response.json())
      .then((response) =>
        this.onReceiveCandidate(response, name, sessionId, pluginid)
      )
  ...
  // ------------------------------------------
  JanusVideoRoom.prototype.onReceiveCandidate = function (
    dataJson,
    name,
    sessionId,
    pluginid
    ...
    for (var i = 0; i < dataJson.length; i++) {
      ...
      fetch(this.janusUrl + "/" + sessionId + "/" + pluginid, {
        ...
        .then((response) =>
          console.log(
            "onReceiveCandidate janus answer:" + JSON.stringify(response)
          )
        )
        .catch((error) => this.onError("setAnswer " + error));
    }
  ...
  JanusVideoRoom.prototype.keepAlive = function (sessionId) {
    ...
    fetch(this.janusUrl + "/" + sessionId, {
      ...
      .then((response) => response.json())
      .then((response) =>
        console.log("keepAlive answer:" + JSON.stringify(response))
      )
...
else window.JanusVideoRoom = JanusVideoRoom;
